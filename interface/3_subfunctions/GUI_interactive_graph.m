...
% Set the popup menu with the name of the data contained in the file DATA
...
disp('Set Panel Choose signal parameters')
...
disp('Make a new part of the interface visible')
